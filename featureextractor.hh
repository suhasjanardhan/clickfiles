...
#ifndef CLICK_GETFEATURES_HH
#define CLICK_GETFEATURES_HH
...
GetFeatures([I<keywords COUNT_CALL, BYTE_COUNT_CALL>])
...
class GetFeatures : public Element { public:

    GetFeatures() CLICK_COLD;
    ~GetFeatures() CLICK_COLD;

    const char *class_name() const		{ return "GetFeatures"; }
